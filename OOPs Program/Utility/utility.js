...
module.exports = {
    ...
    personState: function () {
        var flag = true;
        var State = read.question("please enter your State : \n");
        while (flag) {
    ...
    personMobile: function () {
        var flag = true;
        var mob = read.question("Please enter your contact number : \n");
        while (flag) {
            if (!isNaN(mob)) {
                flag = false;
            }
    ...
    personZipCode: function () {
        var flag = true;
        var Code = read.question("Please enter your contact number : \n");
        while (flag) {
            if (!isNaN(Code)) {
                flag = false;
            }
